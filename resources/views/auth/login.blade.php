                ...
                <div class="col-lg-5 col-12 bg-white d-flex p-0 tt-login-col shadow">
                    <form class="tt-login-form-wrap p-3 p-md-6 p-lg-6 py-7 w-100" action="{{ route('login') }}" method="POST"
                        ...
                        <div style="margin-top: -100px">
                            <center>
                                <img src="{{ staticAsset('frontend/default/assets/img/banner/logo-skinoasis.png') }}" style="width: 200px; height: 200px" alt="logo">
                            </center>
                        </div>
                        <h5 class="mb-4" style="margin-top: -70px">{{ localize('Welcome') }}
