                ...
                <div class="container">
                    <div class="header-center">
                        <a href="index.html" class="logo">
                            <img src="assets/images/logo.png" alt="SKINOASIS Logo" width="200" height="25">
                        </a>
        ...
        <main class="main">
            <div class="intro-slider-container mb-3 mb-lg-5">
                <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl" data-owl-options='{"dots": true, "nav": false}'>
                    <div class="intro-slide" style="background-image: url(assets/images/home-bg.png);">
                        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="content-right">
                                ...
                                <figure>
                                    <img src="assets/images/demos/demo-30/banners/banner-3.jpg" alt="Banner">
                                </figure>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 p-md-0">
                            <div class="content-left">
                                ...
                                <figure>
                                    <img src="assets/images/demos/demo-30/banners/banner-1.jpg" alt="Banner">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-6">
                            <div class="widget widget-about">
                                <img src="assets/images/logo-black.png" class="footer-logo" alt="Footer Logo" width="200" height="25">
                                <p>
